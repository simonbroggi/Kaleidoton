...
class ExtraPWindow extends PApplet implements WindowListener, ComponentListener {
  ...
  public ExtraPWindow(PApplet theApplet) {
    super();
    papplet = theApplet;
  }

  public ExtraPWindow(PApplet theApplet, String theName, int theWidth, int theHeight) {
    this(theApplet,theName, theWidth, theHeight, "", 30);
  }

  public ExtraPWindow(PApplet theApplet, String theName, int theWidth, int theHeight, String theRenderer, int theFrameRate) {
    super();
    papplet = theApplet;
    myName = theName;
    myTitle = theName;
  ...
  public ExtraPWindow(PApplet theApplet, final String theName, int theX, int theY, int theWidth, int theHeight) {
    this(theApplet, theName, theX, theY, theWidth, theHeight, "", 30);
  }

  public ExtraPWindow(PApplet theApplet, String theName, int theX, int theY, int theWidth, int theHeight, String theRenderer, int theFrameRate) {
    super();
    papplet = theApplet;
    myName = theName;
    myTitle = theName;
